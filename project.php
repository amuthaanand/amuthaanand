...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid tm-container-content tm-mt-60">
            ...
            <?php $sql = "SELECT * FROM (SELECT * FROM project where project_type='Accomplished Project' ORDER BY id DESC LIMIT 2)Var1 ORDER BY id ASC";
                ...
                <figure class="effect-ming tm-video-item">
                    <a href="project.page.php?show=<?php echo $result->id;?>">
                        <img src="dashboard/project_imgs/<?php echo htmlentities($result->image);?>" alt=""  height="200px" width="400px"/>
                    ...
                    <center>
                    <p style="padding-bottom: 0px;"><?php echo htmlentities($result->project_name);?></p>
                    <p style="padding-bottom: 0px;"> Company Name : <?php echo htmlentities($result->company_name);?></p>
